...
exports.default = function (req) {
  ...
  return (0, _redux.createStore)(_reducers2.default, {}, (0, _redux.applyMiddleware)(_reduxThunk2.default.withExtraArgument(axiosServer)) // Add axios server instance to redux thunk
  );
};
